...
export default function Social() {
  return (
    ...
    <div className="social-row " >
      ...
      <a href="https://github.com/BetsDAO" target="_blank" className="bottomImgs" style={{marginLeft:15,marginRight:15}}><img src={img1_2} alt="" className="bottomImgs2" style={{width:30,height:30}}/></a>
      <a href="https://betsdao.medium.com/" target="_blank" className="bottomImgs" style={{marginLeft:15,marginRight:15}}><img src={medium} alt="" className="bottomImgs2" style={{width:30,height:30}}/></a>
      <a href="https://t.me/betsdao" target="_blank" className="bottomImgs" style={{marginLeft:15,marginRight:15}}><img src={img1_4} alt="" className="bottomImgs2" style={{width:30,height:30}}/></a>
    </div>
  );
}
