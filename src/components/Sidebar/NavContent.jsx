...
import { MdOutlineLibraryBooks, MdLiveHelp, MdHail } from "react-icons/md";
...
function NavContent() {
  ...
  const checkPage = useCallback((match, location, page) => {
    ...
    if (currentPath.indexOf("betslip") >= 0 && page === "betslip") {
      return true;
    }
    if (currentPath.indexOf("createevent") >= 0 && page === "createevent") {
      return true;
    }
    if (
      currentPath.indexOf("validateevents") >= 0 &&
      page === "validateevents"
    ) {
      return true;
    }
    if (currentPath.indexOf("selfhelp") >= 0 && page === "selfhelp") {
      return true;
    }
          ...
          <div className="dapp-menu-links">
            <div className="dapp-nav" id="navbarNav">
              ...
              <Link
                ...
                to="/betslip"
                isActive={(match, location) => {
                  return checkPage(match, location, "betslip");
                }}
              >
                <Typography variant="h6" className="fxCenter">
              ...
              <Link
                ...
                to="/createevent"
                isActive={(match, location) => {
                  return checkPage(match, location, "createevent");
                }}
              >
                <Typography variant="h6" className="fxCenter">
                  {/* <SvgIcon color="primary" component={StakeIcon} /> */}
              ...
              <Link
                component={NavLink}
                id="validateevents-nav"
                to="/validateevents"
                isActive={(match, location) => {
                  return checkPage(match, location, "validateevents");
                }}
              >
                <Typography variant="h6" className="fxCenter">
                  {/* <SvgIcon color="primary" component={StakeIcon} /> */}
              ...
              <Link
                ...
                to="/selfhelp"
                isActive={(match, location) => {
                  return checkPage(match, location, "selfhelp");
                }}
              >
                <Typography variant="h6" className="fxCenter">
                  {/* <SvgIcon color="primary" component={StakeIcon} /> */}
