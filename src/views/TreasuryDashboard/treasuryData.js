...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all BETS staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing BETS.",
  ...
  holder: "Holders, represents the total number of Ohmies (sBETS holders)",
  staked: "BETS Staked, is the ratio of sPID to BETS (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sPID emissions can be sustained at a given rate. Lower APY = longer runway",
};
