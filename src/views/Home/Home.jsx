  ...
  return <div className="home_gd">
    ...
    <div className="boodyBox fxColumn">
      ...
      <div className="contentStyle">
        CryptStarter DAO is a decentralized reserve currency protocol based on the BETS token and aims at building a community-owned decentralized financial infrastructure for the crypto world.
      </div>
    ...
    {menu ?
      <div className="moban" onClick={() => ShowhideClick()} >
        <div className="CaiDanlieBiao">
          ...
          <div className="lis2"><a target="_blank" className="a" href="">BetsDAO Pro</a></div>
...
function Inp_Box({idoBalance,busdAmount}) {
  ...
  return <MinInp_Box>
    ...
    PIDAO project will launch on 12:00 8th Nov. 2021, you will be able to claim your BETS token manually on the website. 
    </div>
